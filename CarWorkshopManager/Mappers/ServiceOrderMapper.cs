...
namespace CarWorkshopManager.Mappers
{
    ...
    public partial class ServiceOrderMapper
    {
        ...
        [MapProperty(nameof(ServiceOrder.Comments), nameof(ServiceOrderDetailsViewModel.Comments))]
        public partial ServiceOrderDetailsViewModel ToServiceOrderDetailsViewModel(ServiceOrder order);

        [MapProperty("Author.UserName", "AuthorName")]
        public partial CommentViewModel ToCommentViewModel(OrderComment comment);
    }
}
